...
<CardGrid>
  <Card title="Isolated Environments" icon="laptop">
    Each project runs in its own Docker container, preventing dependency conflicts and keeping your host system clean. Containers restart automatically and persist between reboots.
  </Card>
